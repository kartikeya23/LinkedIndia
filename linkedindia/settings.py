"""
Django settings for linkedindia project.
...
SECRET_KEY = 'jr_ywau43+is=ev=q%55$7eka7-hq2$%h8fxwt0l#d=l5dirp3'
...
WSGI_APPLICATION = 'linkedindia.wsgi.application'
